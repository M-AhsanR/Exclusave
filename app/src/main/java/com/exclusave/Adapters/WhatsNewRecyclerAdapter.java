...
public class WhatsNewRecyclerAdapter extends RecyclerView.Adapter<WhatsNewRecyclerAdapter.MyViewHolder> {
    ...
    ArrayList<WhatsNew_Data> arrayList;
    ...
    public WhatsNewRecyclerAdapter(Context context, ArrayList<WhatsNew_Data> arrayList, CustomItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final WhatsNewRecyclerAdapter.MyViewHolder viewHolder = new WhatsNewRecyclerAdapter.MyViewHolder(view);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.whatsnew_title.setText(arrayList.get(position).getTitle());
        Picasso.get().load(Constants.URL.IMG_URL + arrayList.get(position).getCoverImage()).into(holder.roundedImageView);
        Picasso.get().load(Constants.URL.IMG_URL + arrayList.get(position).getCategoryImage()).into(holder.whatsnew_icon);

        Log.e("goldenImg", Constants.URL.IMG_URL + arrayList.get(0).getCategoryImage());

        if(arrayList.get(position).getIsAddedToFavourite() == 1){
            Log.e("LikedUnlike", "Liked");
            holder.favBtn.setLiked(true);
//            holder.favBtn.setCircleStartColorInt(Color.parseColor(sharedPreferences.getString("FontColor", "")));
//            holder.favBtn.setExplodingDotColorsInt(Color.parseColor(sharedPreferences.getString("FontColor", "")), Color.parseColor(sharedPreferences.getString("FontColor", "")));
        }else if(arrayList.get(position).getIsAddedToFavourite() == 0){
            Log.e("LikedUnlike", "Unliked");
...
//                addToFav(position);
                ...
                body.put("StoreID", arrayList.get(position).getStoreID());
                body.put("Type", "add");
...
//        Map<String,String> body = new HashMap<String, String>();
//        body.put("UserID", sharedPreferences.getString("UserID",""));
//        body.put("StoreID", arrayList.get(poistion).getStoreID());
//        body.put("Type", "add");
//        body.put("AndroidAppVersion", String.valueOf(BuildConfig.VERSION_CODE));
////        body.put("Language",language);
//
